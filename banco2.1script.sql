...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_aluguel` (
  ...
  CONSTRAINT `fk_tb_aluguel_tb_pagamento1`
    ...
    REFERENCES `mydb`.`tb_pagamento` (`idtb_pagamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_veiculo_has_tb_aluguel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tb_veiculo_has_tb_aluguel` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_pessoas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tb_pessoas` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_pessoa_juridica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tb_pessoa_juridica` (
  ...
  CONSTRAINT `fk_tb_pessoa_juridica_tb_pessoas1`
    ...
    REFERENCES `mydb`.`tb_pessoas` (`idpessoas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_pessoa_fisica`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tb_pessoa_fisica` (
  `idpessoa Fissica` INT NOT NULL AUTO_INCREMENT,
  `cpf` VARCHAR(45) NOT NULL,
  `tb_pessoas_idpessoas` INT NOT NULL,
  `cnh` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idpessoa Fissica`),
...
-- -----------------------------------------------------
-- Table `mydb`.`tb_aluguel_has_tb_pessoas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tb_aluguel_has_tb_pessoas` (
  `tb_aluguel_idtb_aluguel` INT NOT NULL,
  `tb_pessoas_idpessoas` INT NOT NULL,
