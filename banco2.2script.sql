...
CREATE TABLE IF NOT EXISTS `bancoveiculos`.`tb_pessoas` (
  ...
  `tb_pessoa_juridica_idpessoa juridica` INT NOT NULL,
  `tb_pessoa_fisica_idpessoa fisica` INT NOT NULL,
  PRIMARY KEY (`idpessoas`, `tb_pessoa_juridica_idpessoa juridica`, `tb_pessoa_fisica_idpessoa fisica`),
  INDEX `fk_tb_pessoas_tb_pessoa_juridica1_idx` (`tb_pessoa_juridica_idpessoa juridica` ASC) VISIBLE,
  INDEX `fk_tb_pessoas_tb_pessoa_fisica1_idx` (`tb_pessoa_fisica_idpessoa fisica` ASC) VISIBLE,
  CONSTRAINT `fk_tb_pessoas_tb_pessoa_juridica1`
    FOREIGN KEY (`tb_pessoa_juridica_idpessoa juridica`)
    REFERENCES `bancoveiculos`.`tb_pessoa_juridica` (`idpessoa juridica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_pessoas_tb_pessoa_fisica1`
    FOREIGN KEY (`tb_pessoa_fisica_idpessoa fisica`)
    REFERENCES `bancoveiculos`.`tb_pessoa_fisica` (`idpessoa fisica`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
