...
<body class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            if (isset($_GET['busca'])) {
                $busca = $_GET['busca'];
                $sql = "SELECT idpessoa_juridica, nome, cnpj, telefone FROM tb_pessoa_juridica JOIN tb_pessoas ON tb_pessoas_idpessoas = idpessoas WHERE nome LIKE '%$busca%' OR cnpj LIKE '%$busca%'";
            } else {
                // Se não houver busca, seleciona todas as pessoas jurídicas
                $sql = "SELECT idpessoa_juridica, nome, cnpj, telefone FROM tb_pessoa_juridica
    ...
    <a href="pdf_pessoaju.php" class="btn btn-secondary">Gerar PDF</a>
